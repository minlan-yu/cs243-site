...
- Give a talk about the whole paper, roughly 20 minutes, as if you were presenting it at the conference where it appeared.
- Cover the motivation (what problem the paper is solving; why this problem wasn't solved before) and the challenges (why this problem is difficult to solve), and tie the parts of the paper together into a single story rather than walking through its sections in order. The bar to clear is Keshav's goal for the second pass: being able to summarize the main thrust of the paper, with supporting evidence, to someone who has not read it.
- Before you write any slides, decide what you want the class to walk away with. Peyton Jones, Hughes, and Launchbury, [How to Give a Good Research Talk](https://www.microsoft.com/en-us/research/wp-content/uploads/2016/08/giving-a-talk.pdf) (ACM SIGPLAN Notices 28(11), 1993), suggest asking "If someone remembers only one thing from my talk, what would I like it to be?" — and then telling the audience the answer outright.
- Open with a concrete example that shows the problem, not with an outline slide or a list of prior work: "if you bore your audience in the first few minutes you may never get them back." Keep using examples throughout, for every definition, mechanism, and result — the most common way a paper talk fails is by being too abstract.
- Prune on purpose. Treat a few parts of the paper in real depth and go lightly on the rest; that is better than a superficial pass over everything, or running out of time before the punchline. Michael Ernst's [How to give a technical presentation](https://homes.cs.washington.edu/~mernst/advice/giving-talk.html) is blunt about the alternative: "If you try to fit the entire technical content of a paper into a talk, you will rush and the audience may come away understanding nothing. It's better to think of the talk as an advertisement for the paper that gives the key ideas, intuitions, and results."
- The same goes for the results: show the one or two graphs that make the paper's case, and redraw them for the screen if the originals are too dense. As Steven Swanson's [Giving Good Talks](https://cseweb.ucsd.edu/~swanson/GivingTalks.html) puts it, a slide's graph "should contain just the data you need to make your point (and put it in context)" — it is the paper, not the talk, that should contain all the data.
- Prepare slides for the talk and submit your slides to the TF by noon on the day before your presentation. Budget about two to three minutes per slide, keep each slide to a handful of points, and plan to talk about your slides rather than read them.
...
### Policy on AI tools
- **Paper reading and presentations:** You are allowed to use AI tools (e.g., ChatGPT, Claude, Copilot) for assistance, but all the Ed posts, slides, and reports must be written by you and contain your own thoughts. Violations of this policy will be considered academic misconduct.
